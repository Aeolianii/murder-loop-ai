...
function proposalPrompt(sourceAgent: string, domain: string): string {
  ...
  return [
    ...
    'For this contract, an authorized inspect, photograph, communicate, secure_entry, pick_up, use_item, or wait event is reversible when its direct effect causes no injury, coercion, destruction, ending, external authority decision, or hidden-state mutation.',
